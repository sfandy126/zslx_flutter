...
+tabbarHight02 : SvgGenImage
+tabbarHight03 : SvgGenImage
+tabbarNormal01 : SvgGenImage
+tabbarNormal02 : SvgGenImage
+tabbarNormal03 : SvgGenImage
+values : SvgGenImage[]
}
...
章节来源
- [lib/gen/assets.gen.dart:1-200](file://lib/gen/assets.gen.dart#L1-L200)
- [flutter_gen.yaml:1-3](file://flutter_gen.yaml#L1-L3)
...
## 结论
通过 lib/utils/exports.dart 的统一导出机制，本项目实现了资源与工具的集中管理与简洁引用。结合 flutter_gen 的类型安全资源访问与集中的主题颜色管理，有效提升了代码的组织性与可维护性。建议在未来逐步将 pages、services、widgets 的公共 API 也纳入统一的导出体系，进一步收敛依赖边界，降低模块间耦合度。
